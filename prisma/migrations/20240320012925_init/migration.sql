/*
  ...
  - Added the required column `contestation` to the `activities` table without a default value. This is not possible if the table is not empty.
  - Added the required column `contested` to the `activities` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_activities" ("activityDate", "activityHours", "activityTypeId", "approved", "createdAt", "description", "evidenceTypeId", "graduationId", "id", "quarterId", "status", "updatedAt", "urlEvidence", "userId") SELECT "activityDate", "activityHours", "activityTypeId", "approved", "createdAt", "description", "evidenceTypeId", "graduationId", "id", "quarterId", "status", "updatedAt", "urlEvidence", "userId" FROM "activities";
